...
| 4️⃣ **演示视频**（加分，2 分 14 秒完整走查） | 仓库内 [`demo/logic_coloc_demo.mp4`](demo/logic_coloc_demo.mp4)（860×1864 竖屏，无音轨）；剪辑方法与原始素材见 [`demo/README.md`](demo/README.md) ｜ 知乎（待上传，占位：`<知乎视频链接>`） |
